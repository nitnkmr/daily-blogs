...
function Signup() {
  ...
  return (
    <>
      <div className="container p-4 mt-10 mx-auto h-screen">
        <div className="card lg:card-side bg-base-100 shadow-xl dark:bg-slate-800 sm:p-10 p-2">
          ...
          <div className="card-body">
            ...
            <label className="input input-bordered flex items-center gap-2">
              ...
              <input type="text" className="grow dark:text-slate-800" placeholder="Email" name="email"
                onChange={(e) =>
                  setUserData({ ...userData, [e.target.name]: e.target.value })
                }/>
            </label>
            <label className="input input-bordered flex items-center gap-2 dark:text-slate-800">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
                fill="currentColor"
            ...
            <label className="input input-bordered flex items-center gap-2 dark:text-slate-800">
              ...
              <input type="password" className="grow dark:text-slate-800" placeholder="Password" name="password"
                onChange={(e) =>
                  setUserData({ ...userData, [e.target.name]: e.target.value })
                }/>
            </label>
            <label className="p-4 rounded-lg bg-blue-600 text-white flex items-center gap-2 active:border">
              <input
                type="submit"
