    ...
    const postData =  (data)=>{
        axios.post(BASE_URL+"/user/login", data)
          .then(function (response) {
            toast.success("Loggedin Successfully", response.data.message);
      ...
      <div className="card lg:card-side bg-base-100 shadow-xl dark:bg-slate-800">
        ...
        <div className="card-body ">
          ...
          <label className="input input-bordered flex items-center gap-2">
            ...
            <input type="text" className="grow dark:text-black" placeholder="Email" name="email"
                onChange={(e) =>
          ...
          <label className="input input-bordered flex items-center gap-2">
              ...
              <input type="password" className="grow dark:text-black" placeholder="Password" name="password" 
                onChange={(e) =>
                  setUserData({ ...userData, [e.target.name]: e.target.value })
                } />
            </label>
          <label className=" p-3 rounded-lg flex items-center gap-2 dark:bg-slate-600 active:border">
